        ...
        <div className="max-w-5xl mx-auto animate-page-enter">
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-24 text-center">
              ...
              <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-1">No webhooks configured</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-5 max-w-xs">
                Subscribe to platform events and get real-time HTTP notifications for deployments, VMs, and more.
              </p>
              <button
                onClick={() => setShowCreate(true)}
